...
const ConnectButton: React.FC<Props> = ({ title, icon, callback }) => {
  return (
    <button
      className="flex items-center justify-center bg-dimGray active:bg-dimGray-400 text-white py-3 px-5 rounded-xl border-none text-base font-semibold whitespace-nowrap"
      onClick={callback}
    >
