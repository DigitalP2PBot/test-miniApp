            ...
            <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
                    <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg p-8 flex justify-center flex-col">
                        <h5 className="text-center font-bold mb-4">{i18n.t("approvedTransaction")}</h5>
                        <p>{i18n.t("momentToMoveFunds")}</p>
                        <PrimaryButton className="mt-4" title={i18n.t("moveFunds")} callback={() => null}/>
                    </div>
                </div>
            </div>
        </div>
